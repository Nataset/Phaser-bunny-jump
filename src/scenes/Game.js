...
export default class Game extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('jump', 'assets/sfx/phaserJump1.ogg');
    ...
    create() {
        ...
        this.carrotsCollectedText = this.add
            .text(100, 10, 'Carrots: 0', style)
            .setScrollFactor(0)
            .setOrigin(0.5, 0);

        this.FPS = this.add.text(400, 10, 'FPS: 0', style).setScrollFactor(0).setOrigin(0.5, 0);
    }
    ...
    update(t, dt) {
        this.platforms.children.iterate(child => {
            ...
            if (platform.y >= scrollY + 700) {
                platform.y = scrollY - Phaser.Math.Between(20, 40);
        ...
        if (this.cursors.left.isDown && !touchingDown) this.player.setVelocityX(-200);
    ...
    handleFPSCount(dt) {
        const value = `FPS: ${(1000 / dt).toFixed(0)}`;
        this.FPS.text = value;
    }
}
